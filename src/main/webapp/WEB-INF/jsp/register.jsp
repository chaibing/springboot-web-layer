    ...
    <div class="layadmin-user-login-main">
        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            ...
            <div class="layui-form-item">
                ...
                <input type="text" name="username" id="LAY-user-login-nickname" lay-verify="username" placeholder="昵称"
                       class="layui-input">
            </div>
            ...
            <div class="layui-form-item">
                ...
                <input type="password" name="repass" id="repass" lay-verify="required|repass" placeholder="确认密码"
                       class="layui-input">
            </div>
            ...
            <div class="layui-trans layui-form-item layadmin-user-login-other">
                ...
                <a href="/index" class="layadmin-user-jump-change layadmin-link layui-hide-xs">用已有帐号登入</a>
                <a href="login.jsp"
...
<script>
    layui.use(['form', 'jquery'], function () {
        ...
        form.on('submit(user-reg-submit)', function (data) {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/layuiadmin/register",
                type: "post",
                async: false,
                data: data.field,
                dataType: "json",
